...
var $author$project$Main$getIllegalToken = function (string) {
	var step = F2(
		function (_char, search) {
			...
			var illegalToken = search.illegalToken;
			if (illegalToken.$ === 'Nothing') {
				if (!openBrackets.b) {
					return _Utils_update(
						search,
						{
							openBrackets: A2($elm$core$List$cons, _char, _List_Nil)
						});
				} else {
					var x = openBrackets.a;
					var xs = openBrackets.b;
					return ((_Utils_eq(
						x,
...
var $author$project$Main$viewModel = function (input) {
	return 'number of lines = ' + $elm$core$String$fromInt(
		$elm$core$List$length(input));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Main$linkToInput, 2021, 10)),
