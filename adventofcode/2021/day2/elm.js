...
var $author$project$Main$defaultContent = 'forward 5\ndown 5\nforward 8\nup 3\ndown 8\nforward 2';
...
var $author$project$Main$Forward = function (a) {
	return {$: 'Forward', a: a};
};
...
var $author$project$Main$parseString = function (str) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
		...
		switch (x) {
			case 'forward':
				var _v3 = $elm$core$String$toInt(y);
				if (_v3.$ === 'Just') {
					var val = _v3.a;
					return $elm$core$Maybe$Just(
						$author$project$Main$Forward(val));
				} else {
					return $elm$core$Maybe$Nothing;
				}
			case 'down':
				var _v4 = $elm$core$String$toInt(y);
				if (_v4.$ === 'Just') {
					var val = _v4.a;
					return $elm$core$Maybe$Just(
						$author$project$Main$Down(val));
				} else {
					return $elm$core$Maybe$Nothing;
				}
			case 'up':
				var _v5 = $elm$core$String$toInt(y);
				if (_v5.$ === 'Just') {
					var val = _v5.a;
					return $elm$core$Maybe$Just(
						$author$project$Main$Up(val));
				} else {
					return $elm$core$Maybe$Nothing;
				}
			default:
...
var $author$project$Main$doMoves = F2(
	function (moves, pos) {
		return A3($elm$core$List$foldl, $author$project$Main$doMove, pos, moves);
	});
var $author$project$Main$solution1 = function (_v0) {
	var input = _v0.input;
	var _v1 = A2(
		$author$project$Main$doMoves,
		input,
		{aim: 0, depth: 0, horizontal: 0});
	var horizontal = _v1.horizontal;
	var depth = _v1.depth;
	var aim = _v1.aim;
	return horizontal * depth;
};
var $author$project$Main$doNewMove = F2(
	function (move, position) {
		var horizontal = position.horizontal;
		var depth = position.depth;
		var aim = position.aim;
		switch (move.$) {
			case 'Forward':
				...
				return _Utils_update(
					position,
					{depth: depth + (aim * value), horizontal: horizontal + value});
			case 'Down':
				var value = move.a;
				return _Utils_update(
					position,
...
var $author$project$Main$doNewMoves = F2(
	function (moves, pos) {
		return A3($elm$core$List$foldl, $author$project$Main$doNewMove, pos, moves);
	});
var $author$project$Main$solution2 = function (_v0) {
	var input = _v0.input;
	var _v1 = A2(
		$author$project$Main$doNewMoves,
		input,
		{aim: 0, depth: 0, horizontal: 0});
	var horizontal = _v1.horizontal;
	var depth = _v1.depth;
