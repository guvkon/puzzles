...
var $author$project$Main$defaultContent = '2199943210\n3987894921\n9856789892\n8767896789\n9899965678';
...
var $author$project$Main$parseInput = function (string) {
	...
	return A3(
		iFoldl,
		F3(
			function (y, row, heightMap) {
				return A3(
					iFoldl,
					F3(
						function (x, value, map) {
							return A3(
...
var $author$project$Main$getLowPoints = function (heightmap) {
	var isLowPoint = function (_v1) {
		...
		var neighbors = _List_fromArray(
			[up, down, left, right]);
		var checkNeighbor = F2(
			function (neighbor, acc) {
				if (neighbor.$ === 'Nothing') {
					return acc && true;
				} else {
					var val = neighbor.a;
					return acc && (_Utils_cmp(val, height) > 0);
				}
			});
...
var $author$project$Main$viewModel = function (model) {
	return 'number of points = ' + $elm$core$String$fromInt(
		$elm$core$List$length(
			$elm$core$Dict$toList(model.input)));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Main$linkToInput, 2021, 9)),
