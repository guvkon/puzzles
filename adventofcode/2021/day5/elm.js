...
var $author$project$Main$defaultContent = '0,9 -> 5,9\n8,0 -> 0,8\n9,4 -> 3,4\n2,2 -> 2,1\n7,0 -> 7,4\n6,4 -> 2,0\n0,9 -> 2,9\n3,4 -> 1,4\n0,0 -> 8,8\n5,5 -> 8,2';
...
var $author$project$Main$Vector = F4(
...
var $author$project$Main$parseVector = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$keeper,
				$elm$parser$Parser$succeed($author$project$Main$Vector),
				A2(
...
var $author$project$Main$parseInput = function (str) {
	var parseVectors = function (vec) {
		var _v0 = A2($elm$parser$Parser$run, $author$project$Main$parseVector, vec);
		if (_v0.$ === 'Ok') {
			var pass = _v0.a;
			return $elm$core$Maybe$Just(pass);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	};
...
var $author$project$Main$coordToSpaceKey = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
...
var $author$project$Main$addCoordinatesToSpace = F2(
	function (coord, space) {
		var set = function (value) {
			if (value.$ === 'Just') {
				var val = value.a;
				return $elm$core$Maybe$Just(val + 1);
			} else {
		...
		return A3(
			...
			$author$project$Main$coordToSpaceKey(coord),
			set,
			space);
	});
...
var $author$project$Main$calculateSpace = function (space) {
	return A3(
		$elm$core$Dict$foldl,
		F3(
			function (_v0, v, sum) {
...
var $author$project$Main$vectorToCoordinates1 = function (_v0) {
	var x1 = _v0.x1;
	var y1 = _v0.y1;
	var x2 = _v0.x2;
	var y2 = _v0.y2;
...
var $author$project$Main$solution1 = function (_v0) {
	...
	var drawVector = F2(
		function (vector, space) {
			return A3(
				$elm$core$List$foldl,
				$author$project$Main$addCoordinatesToSpace,
				space,
				$author$project$Main$vectorToCoordinates1(vector));
		});
	return $elm$core$Maybe$Just(
		$author$project$Main$calculateSpace(
			A3($elm$core$List$foldl, drawVector, $elm$core$Dict$empty, input)));
};
...
var $author$project$Main$vectorToCoordinates2 = function (_v0) {
	var x1 = _v0.x1;
	var y1 = _v0.y1;
	var x2 = _v0.x2;
	var y2 = _v0.y2;
	...
	var drawVector = F2(
		function (vector, space) {
			return A3(
				...
				$author$project$Main$addCoordinatesToSpace,
				space,
				$author$project$Main$vectorToCoordinates2(vector));
		});
	return $elm$core$Maybe$Just(
		$author$project$Main$calculateSpace(
			A3($elm$core$List$foldl, drawVector, $elm$core$Dict$empty, input)));
...
var $author$project$Main$viewModel = function (model) {
	return 'number of vectors = ' + $elm$core$String$fromInt(
