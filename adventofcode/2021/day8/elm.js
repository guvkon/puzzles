...
var $author$project$Main$parseInput = function (string) {
	var parseSection = function (str) {
		return $elm$core$String$words(str);
	};
	...
	var convertToTuple = function (strings) {
		return _Utils_Tuple2(
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($author$project$Utils$element, 0, strings)),
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($author$project$Utils$element, 1, strings)));
	};
	return A2(
		$elm$core$List$map,
		convertToTuple,
...
var $author$project$Main$solution1 = function (input) {
	var match = function (str) {
		var _v1 = $elm$core$String$length(str);
		switch (_v1) {
			case 2:
				return true;
			case 4:
	...
	var count = function (pair) {
		...
		return A3(
			$elm$core$List$foldl,
			$author$project$Utils$counter(match),
			0,
			right);
	};
	return $elm$core$Maybe$Just(
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Main$linkToInput, 2021, 8)),
