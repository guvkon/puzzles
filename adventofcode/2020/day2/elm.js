...
var $author$project$Main$defaultContent = '1-3 a: abcde\n1-3 b: cdefg\n2-9 c: ccccccccc';
...
var $author$project$Main$Password = F4(
	function (min, max, symbol, pass) {
		return {max: max, min: min, pass: pass, symbol: symbol};
	});
...
var $author$project$Main$letters = $elm$parser$Parser$getChompedString(
	A2(
...
var $author$project$Main$password = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$keeper,
				$elm$parser$Parser$succeed($author$project$Main$Password),
				A2(
					$elm$parser$Parser$ignorer,
...
var $author$project$Main$parseString = function (str) {
	var _v0 = A2($elm$parser$Parser$run, $author$project$Main$password, str);
	if (_v0.$ === 'Ok') {
		var pass = _v0.a;
...
var $author$project$Main$validPassword2 = function (_v0) {
	var min = _v0.min;
	var max = _v0.max;
	var symbol = _v0.symbol;
	var pass = _v0.pass;
	var chars = $elm$core$Array$fromList(
		$elm$core$String$toList(pass));
	var _char = function () {
		var _v3 = $elm$core$List$head(
			$elm$core$String$toList(symbol));
		if (_v3.$ === 'Just') {
			var chr = _v3.a;
			return chr;
		} else {
	...
	var left = function () {
		var _v2 = A2($elm$core$Array$get, min - 1, chars);
		if (_v2.$ === 'Just') {
			var elem = _v2.a;
			return _Utils_eq(elem, _char);
		} else {
			return false;
		}
	}();
	var right = function () {
		var _v1 = A2($elm$core$Array$get, max - 1, chars);
		if (_v1.$ === 'Just') {
			var elem = _v1.a;
			return _Utils_eq(elem, _char);
		} else {
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Input size: ' + $elm$core$String$fromInt(
