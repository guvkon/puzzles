...
var $author$project$Main$parseField = A2(
...
var $author$project$Main$stringsToPassport = function (strings) {
	var step = function (str) {
		var _v0 = A2($elm$parser$Parser$run, $author$project$Main$parseField, str);
		if (_v0.$ === 'Ok') {
			var fld = _v0.a;
			return ($elm$core$String$isEmpty(fld.key) || $elm$core$String$isEmpty(fld.value)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(fld);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	};
	return A2($elm$core$List$filterMap, step, strings);
};
...
var $author$project$Main$parseInput = function (str) {
	return A2(
		...
		A2(
			$elm$core$List$map,
			$author$project$Main$stringsToPassport,
			A2(
				$elm$core$List$map,
